...
logging.basicConfig(level=logging.DEBUG, filename=os.environ.get("LOGGING_FILEPATH"))
...
def scrape_loop(scraper: ParariusScraper, dbqueries: DBQueries) -> None:
    ...
    if new_houses:
        ...
        dbqueries.add_email(Email(address=os.environ.get("TO_EMAIL"), timestamp=datetime.now()))
